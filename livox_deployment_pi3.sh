...
sudo systemctl stop slam_startup.service autonomous_flight.service
sudo systemctl disable autonomous_flight.service
sudo rm /var/etc/systemd/system/autonomous_flight.service
docker pull alieimaan/iq-nano:livox_slam
...
sudo ln -s $ServicesPath/slam_startup.service $SystemPath/slam_startup.service
if [ $? -eq 0 ]; then
    echo "---------------------- 20: Successfully created symlink for slam_startup.service ----------------------"
else
    echo "---------------------- 20: encountered an error ----------------------"
    exit 1
fi

sudo chmod u+x $SystemPath/slam_startup.service
if [ $? -eq 0 ]; then
    echo "---------------------- 21: Successfully make services executables ----------------------"
else
    echo "---------------------- 21: encountered an error ----------------------"
...
sudo systemctl enable slam_startup.service
if [ $? -eq 0 ]; then
    echo "---------------------- 23: Successfully enabled services to run on startup ----------------------"
else
    echo "---------------------- 23: encountered an error ----------------------"
...
sudo systemctl start slam_startup.service
if [ $? -eq 0 ]; then
    echo "---------------------- 24: Successfully started services ----------------------"
else
    echo "---------------------- 24: encountered an error ----------------------"
...
sudo systemctl status slam_startup.service
